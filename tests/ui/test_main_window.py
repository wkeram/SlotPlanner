...
class TestMainWindowUI:
    ...
    def test_year_selection_changes_data(self, qapp, temp_storage):
        ...
        data_2023 = {
            "teachers": {"Teacher_2023": {"name": "Teacher 2023", "availability": {"monday": ["08:00"], "tuesday": [], "wednesday": [], "thursday": [], "friday": []}}},
            "children": {"Child_2023": {"name": "Child 2023", "availability": {"monday": ["08:00"], "tuesday": [], "wednesday": [], "thursday": [], "friday": []}, "preferred_teachers": []}},
            "tandems": {},
            "weights": {"teacher_preference": 0.5, "early_time": 0.3, "tandem_fulfillment": 0.7, "stability": 0.4}
        }
        
        data_2024 = {
            "teachers": {"Teacher_2024": {"name": "Teacher 2024", "availability": {"monday": ["09:00"], "tuesday": [], "wednesday": [], "thursday": [], "friday": []}}},
            "children": {"Child_2024": {"name": "Child 2024", "availability": {"monday": ["09:00"], "tuesday": [], "wednesday": [], "thursday": [], "friday": []}, "preferred_teachers": []}},
            "tandems": {},
