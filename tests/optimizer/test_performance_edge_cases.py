    ...
    def test_minimal_availability_windows(self, temp_storage):
        ...
        test_data = {
            "teachers": {
                "Busy_Teacher": {
                    "name": "Busy Teacher",
                    "availability": {"monday": [], "tuesday": [], "wednesday": ["14:00"], "thursday": [], "friday": []},
                }
            },
            "children": {
                **{
                    ...
                    for i in range(1, 4)
                }  # 3 children competing for 1 slot
            },
            "tandems": {},
...
class TestEdgeCases:
    ...
    def test_memory_usage_large_dataset(self, temp_storage):
        ...
        assert (
            len(assignments) >= 10
        ), f"Should assign reasonable number of children from large dataset, got {len(assignments)}"
