...
def refresh_teacher_table(window: QWidget, data: dict) -> None:
    ...
    table.setHorizontalHeaderLabels([get_translations("name"), get_translations("weekly_availability")])
...
def refresh_children_table(window: QWidget, data: dict) -> None:
    ...
    table.setHorizontalHeaderLabels([
        ...
        get_translations("early_time_preference_child"), 
        get_translations("preferred_teachers"), 
        get_translations("weekly_availability")
    ])
    table.horizontalHeader().setSectionResizeMode(QHeaderView.Stretch)
...
def refresh_tandems_table(window: QWidget, data: dict) -> None:
    ...
    table.setHorizontalHeaderLabels([
        ...
        get_translations("first_child"), 
        get_translations("second_child"), 
